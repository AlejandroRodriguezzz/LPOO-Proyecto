...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->dataGridView1->Size = System::Drawing::Size(643, 98);
			...
			this->button1->Click += gcnew System::EventHandler(this, &frmBandejaEntrada::button1_Click);
			// 
			// button2
			// 
			this->button2->Location = System::Drawing::Point(369, 305);
			...
			this->ClientSize = System::Drawing::Size(705, 367);
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		frmEnvioMensajes^ ventanaMenssajes = gcnew frmEnvioMensajes();
		ventanaMenssajes->Show();
